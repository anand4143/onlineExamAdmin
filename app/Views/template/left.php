        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="<?php echo base_url();?>/course/list">All courses</a></li>
                    <li><a href="<?php echo base_url();?>/course/create">Create course</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><a href="<?php echo base_url();?>/test/list">All test</a></li>
                    <li><a href="<?php echo base_url();?>/test/create">Create test</a></li>
                </ul>
            </li>
